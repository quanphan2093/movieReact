      ...
      <div className="w-full h-full flex  items-center justify-center space-x-[30px] p-7 relative z-20">
        <div className="flex flex-col space-y-5 items-baseline w-[50%]">
          ...
          <div className="flex flex-col space-y-4 ">
            ...
            <p className="text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus harum omnis obcaecati atque deleniti porro repellendus vitae explicabo repellat illo, enim, quibusdam sunt tempora? Saepe commodi maxime repellat excepturi doloribus!</p>
        ...
        <div className="w-[50%] flex items-center justify-center">
          <div className="w-[300px] h-[400px] relative group cursor-pointer">
            ...
            <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out">
              <img src={IconPlay} alt="play" className="w-16 g-16"/>
            </div>
          </div>
        </div>
      </div>
